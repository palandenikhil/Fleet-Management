...
import './CustomerInfo.css'; // Assuming you add the CSS to this file
        ...
        <Row className="justify-content-center mt-0">
            <Col md={6} className="login-container">
                <Form onSubmit={handleSubmit} className="login-form">
                    ...
                    <Form.Group controlId="creditCardType" className="form-group">
                    ...
                    <Form.Group controlId="creditCardNumber" className="form-group">
